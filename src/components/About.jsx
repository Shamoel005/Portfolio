...
export default function About() {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: SparklesIcon,
      items: ["Java (Expert)", "Python", "JavaScript", "1550+ LeetCode", "300+ Problems Solved"],
      color: "green"
    }
  ];
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            >
              ...
              <p className="text-lg leading-relaxed text-gray-700 mb-4">
                ...
                a deep foundation in <span className="font-semibold">Java, Data Structures, and Algorithms</span> (1550+ LeetCode rating). 
