...
const certificationsData = [
  {
    ...
    credentialUrl: "https://catalog-education.oracle.com/ords/certview/sharebadge?id=A6D516BE0A300B3E4D8554DD7CE2EF95C0FB845461BCABEB5C11D20138097478",
    icon: FaAward,
    color: "orange"
  },
  {
    ...
    date: "2025",
    score: "90%+",
    description: "Comprehensive Python programming course covering fundamentals, data structures, and problem-solving techniques with excellent performance.",
    credentialUrl: "https://archive.nptel.ac.in/content/noc/NOC25/SEM2/Ecertificates/106/noc25-cs103/Course/NPTEL25CS103S106610063310638117.pdf",
    icon: FaCode,
    color: "blue"
  },
  {
    ...
    date: "2025",
    score: "90%+",
    description: "Advanced cloud computing concepts including virtualization, distributed systems, and cloud architecture with distinction performance.",
    credentialUrl: "#", // Add your Cloud Computing certificate URL here
    icon: FaAward,
    color: "purple"
  },
  {
          ...
          >
            {certificationsData.map((cert, index) => (
              <motion.div
                ...
                className={`${getBgColorClasses(cert.color)} rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 flex flex-col`}
              >
                <div className={`p-4 ${getIconBgColor(cert.color)} rounded-xl inline-block mb-4 w-fit`}>
                ...
                <div className="flex items-center text-sm text-gray-600 mb-3 flex-wrap gap-2">
                  ...
                  {cert.score && (
                    <>
                      <span>•</span>
                      <span className={`font-bold ${getIconTextColor(cert.color)}`}>{cert.score}</span>
                    </>
                  )}
                </div>
                ...
                {cert.credentialUrl && (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`mt-auto inline-flex items-center justify-center gap-2 px-4 py-2 ${getBadgeColor(cert.color)} rounded-lg font-semibold text-sm shadow-md hover:shadow-lg transition-all duration-300`}
                  >
