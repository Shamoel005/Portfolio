      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-gray-500 mb-6">
            <span className="bg-white px-4 py-2 rounded-full shadow-sm">1550+ LeetCode Rating</span>
            <span className="bg-white px-4 py-2 rounded-full shadow-sm">300+ DSA Problems</span>
